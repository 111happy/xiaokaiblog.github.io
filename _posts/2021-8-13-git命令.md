...
![]({{site.url}}/assets/img/git/git-branch.png)
...
![]({{site.url}}/assets/img/git/git-push-life.png)
...
![]({{site.url}}/assets/img/git/git-tag.png)

+ 码云的tag标记

![]({{site.url}}/assets/img/git/git-tag-gitee.png)
...
![]({{site.url}}/assets/img/git/整体就是工作区.png)
    
+ 本地版本库(Local Repository)
    - 就是项目隐藏目录.git文件夹，这个是`git`的版本库

![]({{site.url}}/assets/img/git/文件查看.png)
    
+ 暂存区
    - 项目目录下面叫`stage`或者`index`的叫做暂存区

![]({{site.url}}/assets/img/git/暂存区.png)
...
![]({{site.url}}/assets/img/git/各个区域流程图.webp)
...
![]({{site.url}}/assets/img/git/交互cmd.png)
...
![]({{site.url}}/assets/img/git/git-add-p.png)
...
![]({{site.url}}/assets/img/git/git-branch-a-r.png)
...
![]({{site.url}}/assets/img/git/git-branch-vv.png)
...
![]({{site.url}}/assets/img/git/git-stash.png)
...
![]({{site.url}}/assets/img/git/git-stash-apply.png)
...
![]({{site.url}}/assets/img/git/git-diff.png)
...
![]({{site.url}}/assets/img/git/git-remote.png)
